...
*KU18*为自建的函数库，包含一些基础动作函数，根据敌机相对位置计算敌机实际位置，弧度角度转换等，也是*defensexample* 和 *APFexample* 的库

*defensexample* 根据攻击方向和敌机位置做出躲避机动动作，实现躲避机动。

*APF&nbsp;example* 利用人工势场法，将敌方飞机作为引力，战场边界和禁飞区的几何外壁作为斥力，实现追击敌机效果并使我方飞机始终保持在战场内并避免进入禁飞区。
